...
ActiveRecord::Schema.define(version: 2019_11_06_203327) do
  ...
  create_table "tuiters", force: :cascade do |t|
    t.integer "user_id", null: false
    t.text "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    ...
    t.index ["user_id"], name: "index_tuiters_on_user_id"
  end
